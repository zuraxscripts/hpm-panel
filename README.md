...
```batch
git clone -b windows https://github.com/zuraxscripts/hmp-panel.git
cd hmp-panel
```
...
👉 **[HMP Panel for Linux](https://github.com/zuraxscripts/hmp-panel/tree/linux)**
...
No. Use the **[Linux version](https://github.com/zuraxscripts/hmp-panel/tree/linux)** instead.
